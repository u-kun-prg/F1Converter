...
namespace F1
{
	...
	public class F1ImData
	{
		...
		///	<summary>
		///	 サンプリングレート付きのPCM中間データリストへのデータ追加
		/// </summary>
		public PcmImData AddSamplingRatePcmImDataList(int chipSelect, PcmDataType pcmDataType, int pcmStart, int pcmSize, int samplingRate, byte[] souceBinaryArray)
		{
			var pcmImData = new PcmImData(chipSelect, pcmDataType, pcmStart, pcmSize, souceBinaryArray);
			pcmImData.m_pcmSamplingRate = samplingRate;
			PcmImDataList.Add(pcmImData);
			return pcmImData;
		}
		///	<summary>
