			...
			private void MMLKeyOn()
			{
				if (!m_isKeyOn)
				{
					...
					else
					{
						...
						m_mdxParser.AddVgmStreamStartSizeFastCallToPlayImData(
										m_mdxParser.m_m6258CS, 
										a1				:	0, 
										code			:	(byte)0x95, 
										vstrmBlockId	:	(int)m_pcmNote, 
										vstrmFlagMode	:	(byte)0, 
										vstrmStart		:	pdxData.m_start, 
										vstrmSize		:	pdxData.m_size, 
										vstrmSamplingRate:	m_mdxParser.m_m6258SamplingRate
						);
